...
export default function GupShupPage({sessionId}: {sessionId: string}) {
  ...
  useLayoutEffect(() => { fetchSessions(); }, []);
  useEffect(() => { filterSessions(); }, [searchQuery, categoryFilter, upcomingSessions]);
  ...
  const fetchSessions = async () => {
    ...
    try {
      ...
      if (completedRes.success) setCompletedSessions(completedRes.data as GupShupSession[]);
      if (registrationsRes.success) setUserRegistrations(registrationsRes.data as GupShupRegistration[]);
    } catch (error) {
  ...
  // Returns true if the current user has a non-cancelled registration for this session
  const isAlreadyRegistered = (sessionId: string) =>
    userRegistrations.some(
      (reg) => reg.session.id === sessionId 
    );

  const getUpcomingRegistrations = () =>
    userRegistrations.filter((reg) =>
      upcomingSessions.find((s) => s.id === reg.session.id && s.status === "upcoming")
    );

  const getCompletedRegistrations = () =>
    userRegistrations.filter((reg) =>
      completedSessions.find((s) => s.id === reg.session.id && s.status === "completed")
    );
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative z-10 h-full flex items-center bg-gradient-to-r from-[#1164A3] to-[#68B9C4]">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold mb-6 text-white">Gup Shup</h1>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-12">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[380px]">
                <Image width={800} height={600} src="/images/Events/gupshup/gupshup 3.jpeg" alt="Casual conversation gathering in the spirit of Gup Shup" className="w-full h-full object-cover" />
                ...
                <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4">
                      <div className={`w-14 h-14 bg-gradient-to-r ${category.color} rounded-2xl flex items-center justify-center text-white mb-4`}>{category.icon}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-52 md:h-60">
              <Image width={800} height={600} src="/images/Events/gupshup/gupshup 4.jpeg" alt="Gup Shup event format" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  ...
                  <p className="text-white/85 text-sm leading-relaxed">From speaker insight to open floor — a fluid, inclusive format designed for genuine exchange.</p>
                </div>
              </div>
            </div>
                ...
                <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all duration-300">
                  <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
                      <div className="w-20 h-20 bg-gradient-to-r from-[#1164A3] to-[#68B9C4] rounded-2xl flex items-center justify-center text-white flex-shrink-0">{format.icon}</div>
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <div className="w-8 h-8 bg-gradient-to-r from-[#68B9C4] to-[#82B4CC] rounded-full flex items-center justify-center text-white font-bold text-sm">{format.step}</div>
                          <h3 className="text-xl font-bold text-gray-800">{format.title}</h3>
                        </div>
                        <Badge className="flex items-center w-fit bg-[#82B4CC] text-white mb-3"><Clock className="w-3 h-3 mr-1" />{format.duration}</Badge>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[420px]">
                <Image width={800} height={600} src="/images/Events/gupshup/gupshup 1.jpeg" alt="Community members engaging in conversations" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1164A3]/50 to-transparent" />
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">Real conversations, real connections — no formalities, just ideas</p>
                </div>
                  ...
                  <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all duration-300">
                    <CardContent className="p-5">
                      <div className="flex items-start space-x-3">
                        <div className="w-11 h-11 bg-gradient-to-r from-[#1164A3] to-[#68B9C4] rounded-lg flex items-center justify-center text-white flex-shrink-0">{item.icon}</div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-8">
                <Badge className="mb-3 text-base bg-[#1164A3] text-white"><FileCheck className="w-4 h-4 mr-2 inline" />Your Registrations</Badge>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-[#82B4CC]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4 text-base bg-[#1164A3] text-white"><Sparkles className="w-4 h-4 mr-1 inline" />Join Us</Badge>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-52 md:h-[500px]">
              <Image width={800} height={600} src="/images/Events/gupshup/gupshup 2.jpeg" alt="Register for upcoming Gup Shup sessions" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  <h3 className="text-white text-2xl font-bold mb-2">Reserve Your Spot</h3>
                  <p className="text-white/85 text-sm leading-relaxed">Seats are limited — secure your spot in our next Gup Shup and be part of the conversation.</p>
                </div>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredUpcoming.map((sess) => {
                  ...
                  const alreadyRegistered = isAlreadyRegistered(sess.id);
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            if (!buttonDisabled) router.push(`/events/gupshup/${sess.slug}`);
                          }}
                        >
                          {buttonLabel}
