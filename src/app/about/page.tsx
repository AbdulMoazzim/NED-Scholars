        ...
        <div className="max-w-6xl mx-auto px-5">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-12">
              <div>
                ...
                <blockquote className="text-xl italic text-[#1164A3] font-semibold border-l-4 border-[#68B9C4] pl-4 mb-6">
                  &quot;A single person with the right education can change the
                  life of an entire family.&quot;
                </blockquote>
                <p className="text-gray-600 leading-relaxed">
                  Education has the power to rewrite destinies. One empowered
                  learner can uplift siblings, support parents, and inspire
                  entire communities. At NED Scholars, we see every student not
                  just as an individual, but as a future catalyst for change.
                </p>
              </div>
              ...
              <div>
                ...
                <blockquote className="text-xl italic text-[#1164A3] font-semibold border-l-4 border-[#68B9C4] pl-4 mb-6">
                  &quot;We envision a world where equal opportunity in education
                  is a reality, not a privilege.&quot;
                </blockquote>
                <p className="text-gray-600 leading-relaxed">
                  By investing in individuals and cultivating their potential,
                  we create lasting impact—uplifting families, strengthening
                  communities, and building a more equitable and skilled
                  society.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-[700px] hidden lg:block">
              ...
              width={800}
  height={600}
                src="/images/About/aboutus/Our Belief.png"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                width={800}
  height={600}
                  src="/images/About/aboutus/Who we are.jpeg"
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
                <p>
                  <strong className="text-gray-800">NED Scholars</strong> is a
                  non-profit corporation operating exclusively for educational
                ...
                <p>
                  We provide{" "}
                  <strong className="text-[#1164A3]">
                    need-cum-merit based financial assistance
                  </strong>{" "}
                  to deserving students pursuing Bachelor&apos;s level education
                  in{" "}
                  <strong className="text-gray-800">
                    Science, Technology, Engineering, and Mathematics (STEM)
                  </strong>
                  . Our support extends beyond scholarships to include
                  mentorship, internships, training, career guidance, and
                  personal development, enabling students to thrive academically
                  and professionally.
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              NED Scholars began in 2007 as a sincere act of giving back by a
              small group of alumni from NED University&apos;s Mechanical
              Engineering Batch of 1980–1981 (NEDians). The initiative was
              originally established to honor the memory of departed friends
              through named scholarships.
            </p>
          </div>

          <p className="text-center text-gray-600 max-w-3xl mx-auto mb-10">
            What began as support for students within NED University&apos;s
            Mechanical Engineering Department gradually expanded in scope.
            Today, NED Scholars supports deserving STEM students across Pakistan
            and the USA, helping talented individuals overcome financial and
            social barriers to higher education.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {memorialScholarships.map((scholarship) => (
              <div
                ...
                className="bg-white p-6 rounded-xl shadow-lg text-center border border-[#82B4CC]/30 hover:shadow-xl hover:border-[#1164A3] transition-all duration-300"
              >
        ...
        <div className="max-w-4xl mx-auto px-5 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            <h2 className="text-4xl font-bold">
              Support Us | Donate to Promote STEM Education
            </h2>
          </div>
          <p className="text-xl mb-8 opacity-90">
            Education has the power to transform lives—but it requires
            collective effort.
          </p>
          ...
          <p className="text-lg opacity-90 mb-8">
            Your support enables us to cultivate talent, unlock potential, and
            build a stronger future—one scholar at a time.
          </p>
