        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <Badge className="mb-4 text-base">Our Teams</Badge>
                ...
                >
                  <div className="md:flex">
                    ...
                    >
                      ...
                      <a
                        href={team.formLink}
                        className="bg-white text-gray-800 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 inline-flex items-center"
                      >
                        JOIN OUR TEAM
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                View All Teams
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300">
                Contact Us
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4">Volunteer Benefits</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                What You&apos;ll Gain
              </h2>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="shadow-2xl bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-600">
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <button onClick={()=> router.push("/register/volunteer")} className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
