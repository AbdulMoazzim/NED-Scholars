  ...
  const teams = [
    {
      ...
      skills: [
        { title: "Proficiency in Design Software", description: "Knowledge of Adobe Photoshop, Illustrator, or Canva for graphic creation." },
        { title: "Video Editing", description: "Basic skills in Premiere Pro or After Effects for engaging video production." },
    ...
    },
    {
      ...
      skills: [
        { title: "Creativity", description: "Innovate and develop engaging content that captures attention." },
        { title: "Communication", description: "Demonstrate strong verbal and written skills for effective audience interaction." },
    ...
    },
    {
      ...
      skills: [
        { title: "Animation Software Proficiency", description: "Knowledge of tools like Adobe Animate, Blender, or After Effects." },
        { title: "2D and 3D Animation Skills", description: "Ability to create interactive, visually appealing animations." },
    ...
    },
    {
      ...
      skills: [
        { title: "WordPress Proficiency", description: "Skill in creating and maintaining websites using WordPress." },
        { title: "SEO Content Writing", description: "Strong writing skills with a focus on SEO to improve site visibility." },
    ...
    },
    {
      ...
      skills: [
        { title: "Strong Writing Skills", description: "Ability to create clear, concise, and engaging reports and newsletters." },
        { title: "Attention to Detail", description: "Skill in accurately recording meeting minutes and documenting activities." },
    ...
    },
    {
      ...
      skills: [
        { title: "Knowledge of Healthcare Resources", description: "Familiarity with local hospitals, clinics, and affordable healthcare options." },
        { title: "Communication Skills", description: "Ability to compassionately interact with individuals in need and effectively convey medical information." },
    ...
    },
    {
      ...
      skills: [
        { title: "Data Management", description: "Ability to organize, track, and maintain accurate records of laptop allocation and retrieval." },
        { title: "Proficiency in Excel", description: "Skills in Excel for data entry, analysis, and maintaining comprehensive records efficiently." },
    ...
    },
    {
      ...
      skills: [
        { title: "Organizational Skills", description: "Ability to manage event planning, logistics, and coordination effectively." },
        { title: "Communication Skills", description: "Strong interpersonal skills for coordinating with guests, team members, and vendors." },
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                impactful content, and building a stronger community.
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <Card className="text-center p-6 hover:shadow-xl hover:border-[#1164A3] transition-all sm:col-span-1">
                 
                  <h3 className="font-bold text-gray-800 mb-2">Gain Experience</h3>
                  <p className="text-sm text-gray-600">Build valuable skills and enhance your resume</p>
                </Card>
                <Card className="text-center p-6 hover:shadow-xl hover:border-[#1164A3] transition-all sm:col-span-1">
                  
                  <h3 className="font-bold text-gray-800 mb-2">Make an Impact</h3>
                  <p className="text-sm text-gray-600">Help students achieve their dreams and goals</p>
                </Card>
                <Card className="text-center p-6 hover:shadow-xl hover:border-[#1164A3] transition-all sm:col-span-1">
               
                  <h3 className="font-bold text-gray-800 mb-2">Build Network</h3>
                  <p className="text-sm text-gray-600">Connect with like-minded professionals and students</p>
                </Card>

                {/* Benefits row */}
                {[
                  { title: "Skill Development", desc: "Learn new tools and enhance existing skills" },
                  { title: "Networking", desc: "Connect with professionals and peers" },
                  { title: "Certificates", desc: "Receive recognition for your contributions" },
                  { title: "Portfolio Building", desc: "Showcase real projects and experience" },
                ].map((b, i) => (
                  <Card key={i} className="p-5 text-center hover:shadow-xl hover:border-[#1164A3] transition-all">
                    <h4 className="font-bold text-gray-800 mb-1 text-sm">{b.title}</h4>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[500px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Join a growing community making a real difference in students&apos; lives
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Explore our volunteer teams and find the perfect fit for your skills and interests
              </p>
            </div>
                    ...
                    <>
                      ...
                      <Card className="hover:shadow-2xl hover:border-[#1164A3] transition-all duration-300 overflow-hidden h-full">
                        <div className={`bg-gradient-to-r ${team.color} p-6 flex flex-col sm:flex-row items-center gap-4 text-white`}>
                          ...
                          <Link
                            href={team.formLink}
                            className="bg-white text-[#1164A3] px-5 py-2 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 inline-flex items-center text-sm flex-shrink-0"
                          >
                            JOIN
                        ...
                        <CardContent className="p-6">
                          <p className="text-gray-700 leading-relaxed mb-5 text-sm">{team.description}</p>
                          <div className="border-t border-gray-200 pt-5">
                            <h4 className="text-base font-bold text-gray-800 mb-4 flex items-center">
                              <Sparkles className="w-4 h-4 mr-2 text-[#68B9C4]" />
                              ESSENTIAL SKILLS
                            </h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              {team.skills.map((skill, skillIndex) => (
                                <div key={skillIndex} className="flex items-start space-x-2">
                                  ...
                                  <div>
                                    <p className="font-semibold text-gray-800 text-xs">{skill.title}:</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Choose a team that aligns with your skills and passion, and start your volunteer journey with NED Scholars today.
            </p>
            ...
            <Card className="shadow-2xl bg-gradient-to-r from-[#82B4CC]/20 to-[#B0A3B3]/20 border-l-4 border-[#1164A3]">
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <p className="text-lg text-gray-700 mb-8">
                  Whether you have an hour a week or want to dive deep into a project, every contribution matters. Start your journey with NED Scholars today.
                </p>
                <Link href="/register/volunteer" className="bg-gradient-to-r from-[#1164A3] to-[#68B9C4] text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 inline-block">
