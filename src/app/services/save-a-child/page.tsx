...
export default function EducationSupportPakistan() {
  ...
  const crisisStats = [
    { icon: <AlertTriangle className="w-8 h-8" />, number: "22.8M", label: "Out-of-school children (ages 5-16)", description: "Second-highest globally", color: "from-[#1164A3] to-[#68B9C4]", source: "UNICEF 2023" },
    { icon: <TrendingUp className="w-8 h-8" />, number: "44%", label: "Complete secondary education", description: "More than half drop out", color: "from-[#68B9C4] to-[#82B4CC]", source: "World Bank 2024" },
    { icon: <Users className="w-8 h-8" />, number: "31.4%", label: "Youth unemployment (ages 18-25)", description: "Nearly 1 in 3 young people", color: "from-[#82B4CC] to-[#B0A3B3]", source: "Pakistan Bureau of Statistics 2023" },
    { icon: <Briefcase className="w-8 h-8" />, number: "60%", label: "Work in informal jobs", description: "Low-paying without social security", color: "from-[#1164A3] to-[#82B4CC]", source: "Employment Statistics" },
  ];

  const whyItMatters = [
    { icon: <TrendingUp className="w-6 h-6" />, title: "Highest Economic Returns", description: "Early investment in education yields the highest long-term economic returns" },
    { icon: <Users className="w-6 h-6" />, title: "Reduces Unemployment", description: "Quality secondary education reduces youth unemployment by 50%" },
    { icon: <Laptop className="w-6 h-6" />, title: "STEM Employment", description: "STEM-skilled youth are 3x more likely to secure formal employment" },
  ];

  const supportPackage = [
    { icon: <DollarSign className="w-6 h-6" />, title: "Partial Tuition Coverage", description: "40-50% of school fees covered", color: "bg-[#68B9C4]/20 text-[#1164A3]" },
    { icon: <Users className="w-6 h-6" />, title: "Mentorship from Professionals", description: "Career guidance & role models", color: "bg-[#82B4CC]/20 text-[#1164A3]" },
    { icon: <BookOpen className="w-6 h-6" />, title: "After-School Coaching", description: "STEM tutoring & skill development", color: "bg-[#B0A3B3]/30 text-[#1164A3]" },
    { icon: <Heart className="w-6 h-6" />, title: "Parental Engagement Programs", description: "Financial literacy & education advocacy", color: "bg-[#82B4CC]/30 text-[#1164A3]" },
  ];

  const flagshipPrograms = [
    { icon: <Laptop className="w-8 h-8" />, title: "TechAThon", description: "Hands-on technology bootcamps", color: "from-[#68B9C4] to-[#82B4CC]" },
    { icon: <Lightbulb className="w-8 h-8" />, title: "Dare2Design", description: "Innovation & entrepreneurship training", color: "from-[#82B4CC] to-[#B0A3B3]" },
    { icon: <Trophy className="w-8 h-8" />, title: "EMUiNVENT", description: "National & global invention competitions", color: "from-[#1164A3] to-[#68B9C4]" },
  ];

  const selectionCriteria = [
    { icon: <GraduationCap className="w-6 h-6" />, title: "Academic Potential", description: "Strong performance despite financial constraints" },
    { icon: <DollarSign className="w-6 h-6" />, title: "Financial Need", description: "Families struggling to afford education" },
    { icon: <Zap className="w-6 h-6" />, title: "Resilience & Determination", description: "Students committed to long-term growth" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="bg-gradient-to-r from-[#1164A3] via-[#68B9C4] to-[#82B4CC] text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-4 bg-white/20 text-white border-white/30">Education Crisis Response</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Investing in Human Capital Through Targeted Education Support
            </h1>
            <p className="text-xl text-white/90">NED Scholars Pakistan: Transforming Lives Through Education</p>
          </div>
        </div>
      </section>

      {/* Crisis Statistics — stats + image beside quote */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4 bg-[#1164A3] text-white border-[#1164A3]">National Emergency</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Pakistan&apos;s Education Crisis</h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Pakistan faces one of the world&apos;s most severe education crises, with millions of children
                deprived of quality schooling and youth facing staggering unemployment.
              </p>
            </div>
      ...
      {/* Why It Matters — image left, cards right */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                The lack of accessible education creates a cycle of poverty, unemployment, and social
                instability. Research shows that:
              </p>
            </div>
                ...
                <Card className="bg-gradient-to-r from-[#68B9C4] to-[#82B4CC] text-white">
                  <CardContent className="p-4">
                    <p className="font-semibold text-sm">
                      ...
                      students and provides them with the support they need to succeed.
                    </p>
                  </CardContent>
                </Card>
              </div>
      ...
      {/* How It Works — banner image + step cards */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">A comprehensive three-step approach to student success</p>
            </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  ...
                  <p className="text-white/85 text-sm leading-relaxed">
                    Identify talent, provide comprehensive support, then create a pathway to financial
                    independence — all for just $100–$150 per year.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Card className="mb-8 shadow-lg border-[#82B4CC]/20">
              ...
              <CardContent>
                <p className="text-gray-600 mb-6">We partner with schools to select students who demonstrate:</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {selectionCriteria.map((criteria, index) => (
                    <div key={index} className="flex items-start space-x-3 bg-[#82B4CC]/10 p-4 rounded-lg">
              ...
              <CardHeader>
                <CardTitle className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <Badge className="ml-3 bg-[#82B4CC] text-white">$100–$150 per year per student</Badge>
                  </div>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-6">Our model ensures students receive more than just financial aid:</p>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl h-[280px]">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <p className="text-white text-xs font-medium bg-black/30 rounded-xl px-3 py-1.5 backdrop-blur-sm">
                        Holistic support beyond tuition — mentorship, coaching, and family engagement
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Card className="shadow-lg border-[#82B4CC]/20">
              <CardHeader>
                <CardTitle className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-[#82B4CC] to-[#B0A3B3] rounded-full flex items-center justify-center text-white font-bold">3</div>
                  <span>Pathway to Financial Independence</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-6">Supported students gain access to NED Scholars&apos; flagship programs:</p>
                  ...
                  {flagshipPrograms.map((program, index) => (
                    <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all duration-300">
                      <CardContent className="p-6 text-center">
                        <div className={`w-16 h-16 bg-gradient-to-r ${program.color} rounded-full flex items-center justify-center text-white mx-auto mb-4`}>
                          {program.icon}
                        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Impact of Your Support</h2>
              <Card className="inline-block bg-gradient-to-r from-[#68B9C4] to-[#82B4CC] text-white">
                <CardContent className="p-6">
                  <p className="text-xl font-semibold">For just $100–$150 per year, you can:</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    $150 a year keeps a talented student in school and on the path to success
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <Card className="bg-white/10 border-white/20 text-white hover:bg-white/20 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-white/90">$150 covers a full year of support</p>
                </CardContent>
              </Card>
              <Card className="bg-white/10 border-white/20 text-white hover:bg-white/20 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-white/90">Guide students in STEM/career skills</p>
                </CardContent>
              </Card>
              <Card className="bg-white/10 border-white/20 text-white hover:bg-white/20 transition-all duration-300">
                <CardContent className="p-6 text-center">
              ...
              <Card className="shadow-lg border-[#82B4CC]/20">
                <CardContent className="p-8">
                  <ul className="space-y-4">
                    {[
                      <>Pakistan&apos;s education crisis leaves <span className="font-semibold">22.8M children out of school</span></>,
                      <>Youth unemployment at <span className="font-semibold">31.4%</span> due to skills gap</>,
                      <>NED Scholars&apos; solution: Partial scholarships + mentorship <span className="font-semibold">($100–$150/year)</span></>,
                      <>Program includes: <span className="font-semibold">Tuition aid, STEM training, innovation competitions</span></>,
                      <>Proven impact: Students achieve <span className="font-semibold">academic & career success</span></>,
                    ].map((item, index) => (
