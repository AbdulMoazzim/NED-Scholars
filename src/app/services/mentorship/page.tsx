  ...
  const programComponents = [
    {
      ...
      benefits: [
        {
          color: "bg-[#82B4CC]/20",
          text: "Develop a work-study-life balance plan",
        },
        {
          color: "bg-[#68B9C4]/20",
          text: "Identify skill-building opportunities (certifications, workshops)",
        },
        {
          color: "bg-[#B0A3B3]/20",
          text: "Navigate career pathways (industry vs. academia, freelancing, global opportunities)",
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          color: "bg-[#B0A3B3]/20",
          text: "Insights into industry trends (especially in STEM fields)",
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          color: "bg-[#B0A3B3]/20",
          text: "Handle family and academic pressures",
        },
      ],
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
              <div className="flex items-start space-x-4 mb-6">
                ...
                Why Mentorship Matters
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">
                    ...
                    who provide guidance, inspiration, and practical
                    support—helping them navigate academic challenges, career
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    ...
                    <span className="font-semibold">
                      first-in-family achievement
                    </span>
                    . Unlike their peers who may have relatives in engineering
                    or professional fields, most of our students lack immediate
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[380px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/mentorship/mentorship 3.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    One conversation can rewrite a student&apos;s entire
                    trajectory
                  </p>
                </div>
      ...
      <section className="py-16 bg-gradient-to-r from-[#B0A3B3]/10 to-[#82B4CC]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-60 md:h-[300px]">
              <Image
                width={800}
                height={600}
                src="/images/Services/mentorship/mentorship 1.jpeg"
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  ...
                  <p className="text-white/85 text-sm leading-relaxed">
                    Personalized guidance, professional development, and
                    emotional support — every scholar gets what they need to
                    thrive.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Mentors play a vital role in shaping the future of scholars
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                {[
                  {
                    ...
                    text: "Share valuable industry insights and professional experience",
                  },
                  {
                    icon: <Compass className="w-5 h-5" />,
                    text: "Provide career counseling and guidance to students",
                  },
                  {
                    icon: <Wrench className="w-5 h-5" />,
                    text: "Help develop essential technical and professional skills",
                  },
                  {
                    icon: <Lightbulb className="w-5 h-5" />,
                    text: "Support students in making informed career decisions",
                  },
                  {
                    icon: <Network className="w-5 h-5" />,
                    text: "Connect mentees to internships and industry opportunities",
                  },
                  {
                    icon: <Building2 className="w-5 h-5" />,
                    text: "Facilitate industrial visits and practical exposure",
                  },
                  {
                    icon: <TrendingUp className="w-5 h-5" />,
                    text: "Encourage personal and professional growth",
                  },
                ].map((item, index) => (
                  <li
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-xl border border-gray-100 hover:border-[#1164A3] hover:shadow-md transition-all duration-300 bg-white"
                  >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[480px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/mentorship/mentorship 2.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Mentors bridge the gap between education and industry for
                    the next generation
                  </p>
                </div>
                <div className="absolute -bottom-3 -right-3 w-full h-full rounded-2xl border-4 border-[#68B9C4]/30 -z-10" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              <button
                ...
                className="bg-white text-[#1164A3] px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 inline-flex items-center"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <Card className="shadow-2xl bg-gradient-to-r from-[#82B4CC]/20 to-[#B0A3B3]/20 border-l-4 border-[#1164A3]">
                <CardContent className="p-8 md:p-10 text-center">
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    Every successful professional once needed guidance. Now
                    it&apos;s your turn to be that guiding light for someone
                    else.
                  </p>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[70%]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/mentorship/mentorship 4.jpeg"
