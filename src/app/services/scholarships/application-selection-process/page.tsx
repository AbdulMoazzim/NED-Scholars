...
export default function GuidelinesAndPrioritiesPage() {
  ...
  const selectionSteps = [
    ...
    },
    {
      ...
      description:
        "NED CSA compiles and submits applications to Selection Committee",
      icon: ClipboardList,
      details: [
    ...
    },
    {
      ...
      description:
        "Committee evaluates financial need (total earnings / family members)",
      icon: DollarSign,
      details: [
    ...
    },
    {
      ...
      title: "Fund Transfer",
      description:
        "NED Scholars transfers scholarship amount to NED University",
      icon: DollarSign,
      details: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                ...
                <Card className="border-0 shadow-xl">
                  ...
                  <CardContent>
                    <p className="text-gray-700 mb-4">
                      The NED Controller of Student Affairs (CSA) administers
                      the entire scholarship application process with support
                      from NED Scholars alumni.
                    </p>
                    <div className="space-y-2">
                      {[
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[90%]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/Application and Selection proccess/image4.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    A fair, transparent process — built on merit and genuine
                    need
                  </p>
                </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  <h3 className="text-white text-2xl font-bold mb-2">
                    13 Steps to Your Scholarship
                  </h3>
                  <p className="text-white/85 text-sm leading-relaxed">
                    A transparent, end-to-end process — from your first
                    application click to the scholarship reaching your hands.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[600px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/Application and Selection proccess/image1.jpeg"
                      ...
                      {[
                        {
                          ...
                          desc: "Interviews are conducted virtually",
                        },
                        {
                          title: "Parents Must Attend",
                          desc: "Parents/guardians required to be present",
                        },
                        {
                          title: "Recording",
                          desc: "All interviews are recorded for evaluation",
                        },
                        {
                          title: "Evaluation Form",
                          desc: "Standardized scoring by committee members",
                        },
                      ].map((item, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 text-sm">
                          20% of selected scholars&apos; homes are randomly
                          visited by selection committee members or NED CSA
                          representatives to ensure the truthfulness of
                          applications.
                        </p>
                      </div>
                    </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[380px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/Application and Selection proccess/image2.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Home visits ensure every scholarship reaches a truly
                    deserving student
                  </p>
                </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button
                ...
                onClick={() =>
                  router.push("/services/scholarships/eligible-criteria")
                }
              >
                Check Eligibility
              </Button>
