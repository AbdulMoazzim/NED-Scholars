            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[380px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/laptop/laptop 4.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Every laptop opens a door to education, opportunity, and
                    independence
                  </p>
                </div>
                ...
                <div className="flex items-start justify-center text-center space-x-4">
                  ...
                  <div>
                    <p className="text-lg text-gray-700 italic font-bold leading-relaxed mb-4">
                      ...
                      professional university was a testament to a
                      student&apos;s talent.
                    </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-60 md:h-90">
              <Image
                width={800}
                height={600}
                src="/images/Services/laptop/laptop 1.png"
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  <h3 className="text-white text-2xl font-bold mb-2">
                    From Our Hands to Their Future
                  </h3>
                  <p className="text-white/85 text-sm leading-relaxed">
                    368 laptops distributed since 2012 — each one a gateway to
                    opportunity.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-full">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/laptop/laptop 2.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    A laptop unlocks coding, research, freelancing, and career
                    opportunities
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                {studentBenefits.map((item, index) => (
                  <div
                    className="flex items-center space-x-4 p-4 shadow rounded"
                    key={index}
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-12">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px]">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/laptop/laptop 1.jpeg"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Your contribution directly places a device in a deserving
                    student&apos;s hands
                  </p>
                </div>
                <div className="absolute -bottom-3 -left-3 w-full h-full rounded-2xl border-4 border-[#68B9C4]/30 -z-10" />
                  ...
                  >
                    <CardContent>
                      <div className="flex items-start space-x-5">
                        <div
                          className={`w-14 h-14 bg-gradient-to-r ${way.color} rounded-2xl flex items-center justify-center text-white flex-shrink-0`}
                        >
                          {way.icon}
                        </div>
                        <div>
            ...
            <Card className="shadow-xl bg-white border-[#82B4CC]/20">
              <CardContent className="p-8">
                ...
                <div className="text-center">
                  <Link
                    href="/donate"
                    className="bg-gradient-to-r from-[#1164A3] to-[#68B9C4] text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 inline-flex items-center"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-full">
                <Image
                  width={800}
                  height={600}
                  src="/images/Services/laptop/laptop 3.jpeg"
