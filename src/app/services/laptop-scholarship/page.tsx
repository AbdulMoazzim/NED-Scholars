...
export default function LaptopProgramPage() {
  const digitalDivideChallenges = [
    { icon: <BookOpen className="w-6 h-6" />, title: "Academic Struggle", description: "Unable to complete coding assignments, research, or online coursework", color: "bg-[#82B4CC]/20 text-[#1164A3]" },
    { icon: <Briefcase className="w-6 h-6" />, title: "Freelancing Barriers", description: "Missing out on remote work opportunities that could fund their education", color: "bg-[#68B9C4]/20 text-[#1164A3]" },
    { icon: <FileText className="w-6 h-6" />, title: "Job Search Hurdles", description: "Difficulty preparing resumes, applying online, or attending virtual interviews", color: "bg-[#B0A3B3]/30 text-[#1164A3]" },
    { icon: <Code className="w-6 h-6" />, title: "Skill Gap", description: "Falling behind peers in mastering essential software and programming tools", color: "bg-[#82B4CC]/30 text-[#1164A3]" },
  ];

  const programFeatures = [
    { icon: <Laptop className="w-8 h-8" />, title: "Refurbished Laptops", description: "$250–$300 per device", detail: "Quality-tested and ready for academic use", color: "from-[#1164A3] to-[#68B9C4]" },
    { icon: <Target className="w-8 h-8" />, title: "Need-Cum-Merit Basis", description: "Fair and transparent selection", detail: "Financial constraints don't hinder potential", color: "from-[#68B9C4] to-[#82B4CC]" },
    { icon: <Wifi className="w-8 h-8" />, title: "Internet Support", description: "Connectivity stipends available", detail: "Ensuring complete digital access", color: "from-[#82B4CC] to-[#B0A3B3]" },
    { icon: <Users className="w-8 h-8" />, title: "Both Countries", description: "Pakistan & USA support", detail: "Serving NED students globally", color: "from-[#1164A3] to-[#82B4CC]" },
  ];
  ...
  const programTypes = [
    {
      ...
      details: ["For duration of studies", "Returned upon graduation", "Can be extended if needed"],
      color: "from-[#1164A3] to-[#68B9C4]",
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Donation Initiative",
      description: "Gifted to high-achieving scholars or their younger siblings",
      details: ["Permanent ownership", "Long-term family impact", "Extends to next generation"],
      color: "from-[#68B9C4] to-[#82B4CC]",
    },
  ];

  const impactStats = [
    { icon: <Laptop className="w-8 h-8" />, number: "368", label: "Laptops Distributed", description: "Since 2012", color: "from-[#1164A3] to-[#68B9C4]" },
    { icon: <Users className="w-8 h-8" />, number: "Hundreds", label: "Students Empowered", description: "Across Pakistan & USA", color: "from-[#68B9C4] to-[#82B4CC]" },
    { icon: <Briefcase className="w-8 h-8" />, number: "Countless", label: "Careers Launched", description: "In tech and engineering", color: "from-[#82B4CC] to-[#B0A3B3]" },
    { icon: <Calendar className="w-8 h-8" />, number: "13+", label: "Years Running", description: "Since 2012", color: "from-[#1164A3] to-[#82B4CC]" },
  ];

  const studentBenefits = [
    { icon: <Code className="w-6 h-6" />, benefit: "Complete coding assignments and projects" },
    { icon: <BookOpen className="w-6 h-6" />, benefit: "Access online courses and research materials" },
    { icon: <Briefcase className="w-6 h-6" />, benefit: "Pursue freelancing opportunities" },
    { icon: <FileText className="w-6 h-6" />, benefit: "Prepare professional resumes and applications" },
    { icon: <Video className="w-6 h-6" />, benefit: "Attend virtual interviews and meetings" },
    { icon: <Zap className="w-6 h-6" />, benefit: "Master essential software and programming tools" },
  ];

  const donationTiers = [
    { amount: "$250", description: "Sponsors a refurbished laptop", icon: <Laptop className="w-6 h-6" />, impact: "Enables one student to access digital education", color: "from-[#1164A3] to-[#68B9C4]" },
    { amount: "$300", description: "Laptop + internet stipend", icon: <Wifi className="w-6 h-6" />, impact: "Complete digital access for 6 months", color: "from-[#68B9C4] to-[#82B4CC]" },
    { amount: "Recurring", description: "Monthly donations", icon: <TrendingUp className="w-6 h-6" />, impact: "Help us scale this initiative sustainably", color: "from-[#82B4CC] to-[#B0A3B3]" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="bg-gradient-to-r from-[#1164A3] via-[#68B9C4] to-[#82B4CC] text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Badge className="mb-4 bg-white/20 text-white border-white/30">Digital Access Initiative</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Bridging the Digital Divide</h1>
            <p className="text-xl text-white/90 mb-4">NED Scholars Laptop Distribution Program</p>
            <p className="text-lg text-white/80">Transforming Lives Through Technology</p>
          </div>
        </div>
      </section>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <p className="text-lg text-gray-700 leading-relaxed mb-4">
                          ...
                          <span className="font-semibold">access to technology should never be a barrier to education</span>.
                          Since <span className="font-semibold">2012</span>, we have been providing refurbished laptops
                          and internet support to talented yet financially constrained STEM students at NED University
                          in Karachi and in the USA.
                        </p>
                        <p className="text-lg text-gray-700 leading-relaxed">
                          Our mission is simple:{" "}
                          <span className="font-semibold">empower students with the tools they need to excel</span>{" "}
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[380px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Every laptop opens a door to education, opportunity, and independence
                  </p>
                </div>
              ...
              {programFeatures.map((feature, index) => (
                <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <div className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center text-white mx-auto mb-4`}>
                      {feature.icon}
                    </div>
      ...
      {/* How It Works — image banner + loan/donation cards */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                ...
                <span className="font-semibold">need-cum-merit basis</span>, ensuring that financial
                constraints do not hinder potential.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl mb-10 h-60 md:h-90">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  <h3 className="text-white text-2xl font-bold mb-2">From Our Hands to Their Future</h3>
                  <p className="text-white/85 text-sm leading-relaxed">
                    368 laptops distributed since 2012 — each one a gateway to opportunity.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Impact Stats — no image (clean card grid) */}
      <section className="py-16 bg-gradient-to-r from-[#B0A3B3]/10 to-[#82B4CC]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">Over a decade of transforming lives through technology</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {/* Student Benefits — image left, benefit cards right */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4 bg-[#68B9C4] text-white border-[#68B9C4]">What Students Gain</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Unlocking Opportunities</h2>
              <p className="text-gray-600 text-lg">With laptop access, students can pursue their full potential</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[420px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    A laptop unlocks coding, research, freelancing, and career opportunities
                  </p>
                </div>
      ...
      {/* Donation Section — no image (gradient hero-style) */}
      <section className="py-16 bg-gradient-to-r from-[#1164A3] via-[#68B9C4] to-[#82B4CC] text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Join Us in Lighting the Way Forward</h2>
              <p className="text-xl text-white/90">You can help close the digital gap</p>
            </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-xl italic">
                    Join us in lighting the way forward. Support NED Scholars and help us build a brighter future.
                  </p>
                  <div className="text-4xl">&quot;</div>
                </div>
              </CardContent>
      ...
      {/* Get Involved — image beside ways to contribute */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4 bg-[#1164A3] text-white border-[#1164A3]">Get Involved</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">How to Get Involved</h2>
              <p className="text-gray-600 text-lg">Multiple ways to support digital access for students</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-12">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Your contribution directly places a device in a deserving student&apos;s hands
                  </p>
                </div>
                <div className="absolute -bottom-3 -left-3 w-full h-full rounded-2xl border-4 border-[#68B9C4]/30 -z-10" />
              </div>
      ...
      {/* Final Message — image beside closing card */}
      <section className="py-16 bg-gradient-to-r from-[#B0A3B3]/10 to-[#82B4CC]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <Card className="shadow-2xl bg-gradient-to-r from-[#82B4CC]/20 to-[#B0A3B3]/20 border-l-4 border-[#1164A3]">
                <CardContent className="p-8 md:p-10 text-center">
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    Every laptop donated is a door opened, a dream enabled, and a future brightened.
                    Your support transforms lives and breaks down barriers to education.
                  </p>
                  <div className="flex justify-center space-x-6 text-sm text-gray-600">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#1164A3]">368+</div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[440px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    One device. One student. Infinite possibilities.
                  </p>
                </div>
