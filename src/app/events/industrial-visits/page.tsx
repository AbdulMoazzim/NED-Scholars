...
export default function IndustrialVisitsPage() {
  ...
  const getUpcomingRegistrations = () =>
    userRegistrations.filter((reg) => upcomingVisits.find((v) => v.id === reg.visitId && v.status === "upcoming"));

  const getCompletedRegistrations = () =>
    userRegistrations.filter((reg) => pastVisits.find((v) => v.id === reg.visitId && v.status === "completed"));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#1164A3] via-[#68B9C4] to-[#82B4CC] text-white py-20">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Industrial Visits</h1>
            <p className="text-2xl text-white/90 mb-4">Bridging Theory with Practice</p>
      ...
      {/* Overview — image beside overview card */}
      ...
      {/* Objectives — image beside objectives grid */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[440px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    Five clear objectives guide every visit — from exposure to professional ethics
                  </p>
                </div>
      ...
      {/* Industries Covered — image beside industry grid */}
      <section className="py-20 bg-gradient-to-r from-[#B0A3B3]/10 to-[#82B4CC]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[420px]">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white text-sm font-medium bg-black/30 rounded-xl px-4 py-2 backdrop-blur-sm">
                    From manufacturing floors to R&D labs — exposure across Pakistan&apos;s key industries
                  </p>
                </div>
                <div className="absolute -bottom-3 -left-3 w-full h-full rounded-2xl border-4 border-[#82B4CC]/30 -z-10" />
              </div>
                ...
                {industries.map((industry, index) => (
                  <Card key={index} className="hover:shadow-xl hover:border-[#1164A3] transition-all">
                    <CardContent className="p-5 text-center">
                      <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${industry.color} flex items-center justify-center text-white mx-auto mb-3`}>
                        {industry.icon}
                      </div>
      ...
      {/* Upcoming Visits — wide banner image + listings */}
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#1164A3]/65 to-transparent flex items-center">
                <div className="px-10 max-w-lg">
                  ...
                  <p className="text-white/85 text-sm leading-relaxed">
                    Seats are limited — secure your place on the next industrial visit and step inside Pakistan&apos;s leading companies.
                  </p>
                </div>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredVisits.map((visit) => {
                  ...
                  return (
                    <Card key={visit.id} className="hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 border-[#82B4CC]/30 hover:border-[#1164A3]" onClick={() => router.push(`/register/industrial-visit-attendee?visitId=${visit.id}`)}>
                      <CardHeader>
                      ...
                      <CardContent>
                        ...
                        <div className="space-y-3 mb-4">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600"><Calendar className="w-4 h-4 text-[#1164A3]" />{new Date(visit.visitDate).toLocaleDateString()}</div>
                          <div className="flex items-center gap-2 text-sm text-gray-600"><Clock className="w-4 h-4 text-[#1164A3]" />{new Date(visit.startTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}</div>
                          <div className="flex items-center gap-2 text-sm"><Users className="w-4 h-4 text-[#68B9C4]" /><span className={isFull ? "text-red-600 font-semibold" : "text-[#68B9C4] font-semibold"}>{isFull ? "Fully Booked" : `${availableSeats} seats available`}</span></div>
                          {visit.transportProvided && <div className="flex items-center gap-2 text-sm text-[#68B9C4]"><CheckCircle className="w-4 h-4" /><span className="font-medium">Transport Provided</span></div>}
                        </div>
                        ...
                        <Button
                          ...
                          onClick={(e) => { e.stopPropagation(); if (!isFull && registrationOpen) router.push(`/register/industrial-visit-attendee?visitId=${visit.id}`); }}
                          disabled={isFull || !registrationOpen}
                        >
                          {isFull ? "Fully Booked" : !registrationOpen ? "Registration Closed" : "Register Now"}
      ...
      {/* Past Visits — unchanged (already has images from DB) */}
      {pastVisits.length > 0 && (
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
